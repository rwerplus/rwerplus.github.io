...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Java程序员', link: '/pages/e58ecf/' },
        ],
      },
      {
        text: '收藏',
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/playlist?id=88954294',
        },
      ],
    },
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/87452.png' }], //favicons，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
  ...
  plugins: {
   ...
   // 评论区
    'vuepress-plugin-comment': {
      choosen: 'gitalk',
      options: {
        clientID: '5caec8f87d3c2c9c4c2a',
        clientSecret: '0d25fa4927dd65f87b29b546c81eb639d3b624c5',
